...
using Rest.Core.PetaPoco.DatabaseTypes;
using Rest.Core.PetaPoco.Internal;
using System;
...
namespace Rest.Core.PetaPoco
{
    ...
    public class Database : IDisposable
    {
        ...
        public Database(IDbConnection connection)
        {
            ...
            //_sharedConnectionDepth = 0;		// Automatic open and close connection change by Roy.
            CommonConstruct();
        }
        ...
        public void OpenSharedConnection()
        {
            ...
            //Modify by Roy, make sure if the connection need be open.
            ...
            {
                throw new Exception("Connection is not exist or already disposed");
            }
        }
        ...
        public object Insert(object poco)
        {
            ...
            var obj = Insert(pd.TableInfo.TableName, pd.TableInfo.PrimaryKey, pd.TableInfo.AutoIncrement, poco);
            return obj;
        }
    ...
    */
    ...
    namespace Internal
    {
        ...
        internal static class AutoSelectHelper
        {
            ...
            private static Regex rxSelect = new Regex(@"\A\s*(SELECT|EXECUTE|CALL)\s", RegexOptions.Compiled | RegexOptions.Singleline | RegexOptions.IgnoreCase | RegexOptions.Multiline);
