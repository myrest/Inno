    ...
    <table class="body0 StepBody">
        <tr>
            <td>
                <div id="body1">
                    <%
                        QuickControllBarViewModel QCBAR = new QuickControllBarViewModel() { ControlMainTitle = "第4單元作品", ControlSubTitle = "設計專案成果" };
    ...
    <script>
        ...
        var Step = {
            ...
            , SaveData: function () {
                ...
                utility.ajaxQuiet('TopicService/Result3', para, null, utility.ecb);
                Step.ClearForm();
            }
