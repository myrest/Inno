...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%
        Best6_1ViewModel Model = (Best6_1ViewModel)ViewData["Model"];
        var BestGapList = Model.GAPListing;
    %>
    <table class="body0 StepBody">
        <tr>
            <td>
                ...
                <div id="best-2p">
                    1. 機會缺口<span class="right"><!-- input type="button" id="EndBest" value="結束Best分析" / --></span>
                </div>
                <div id="best-ma1">
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="center">
                                                <tr>
                                                    <td align="center" bgcolor="#FFB7FF">分類結果
                                                    </td>
                                                </tr>
                                                <%
                                                    foreach (var item in BestGapList)
                                                    {
                                                        string checkboxHTML = string.Format("<input type=\"checkbox\" name=\"chkGroupName\" id=\"chk_{0}\" value=\"{0}\" />", item.SN);
                                                %>
                                                <tr>
                                                    <td align="center">
                                                        <label for="chk_<%=item.SN %>">
                                                            <%=checkboxHTML %>
                                                            <span><% =item.MyGAP %></span>
                                                        </label>
                                                        <span class="related">
                                                        <%
                                                        bool isFirst = true;
                                                        foreach (var subitem in item.IdeaDetails)
                                                        {
                                                            string commonsymbo = (isFirst) ? "" : "、";
                                                            Response.Write(commonsymbo + subitem.Idea);
                                                            isFirst = false;
                                                        }    
                                                        %>
                                                        </span>
                ...
                <div id="body2-a">
                    2. 點子整理<span id="notice" style="background-color: rgb(255, 195, 195);" class="hidden">
                        資料已更新</span>
                </div>
                <div id="body3">
                    <div id="body-4a">
                    ...
                    <table width="95%" border="0" align="center" id="tbitems">
                        ...
                        <%
                            int i = 0;
                            foreach (var item in Model.GAPIdeaListing)
                            {
                                i++;
                                string image = string.IsNullOrEmpty(item.Document) ? "" : string.Format("<p><img class=\"image\" src=\"{0}\" /></p>", item.Document);
                                string sns = string.Join(",", item.IdeaDetails.Select(x => x.BestGAPSN).ToArray());
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#file_upload').fileUploadUI({
                url: '/FileUploadService/UploadBest6_1Image',
                method: 'POST',
                uploadTable: $('#files'),
                downloadTable: $('#files'),
        ...
        var Step = {
            ...
            , _Delete: function (sn) {
                var para = {
                    'GapIdeaSN': parseInt(sn, 10)
                };
                utility.ajaxQuiet('TopicService/DeleteGAPIdea', para);
            },
            ...
            , UpdateData: function () {
                ...
                utility.ajaxQuiet('TopicService/UpdateBestGAPIdea', para);
                Step.CancleUpdate();
            }
            ...
            , SaveData: function () {
                ...
                if (para === false) {
                    ...
                    utility.ajaxQuiet('TopicService/NewBestGAPIdea', para);
                    Step.ClearForm();
                }
            }
            , ToBestEnd: function () {
