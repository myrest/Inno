    ...
    <table class="body0 StepBody">
        <tr>
            <td>
                <div id="body1">
                    <%
                        QuickControllBarViewModel QCBAR = new QuickControllBarViewModel() { ControlMainTitle = "Set重要性分析", ControlSubTitle = "Set重要性分析" };
                            ...
                            <td>
                                <div class="importblock">
                                    <table width="90%" border="0" align="center">
                                        ...
                                        <%
                                            var i = 0;
                                            var bgColor = "bgcolor=\"#99FFFF\"";
                                            var BtnBGColor = string.Empty;
