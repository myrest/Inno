                            ...
                            <td colspan="3" valign="top">
                                <table width="95%" border="0" align="center">
                                    <tr>
                                        ...
                                        <td valign="top" colspan="3">暱稱：<% =CharModel.NickName%> (<% =CharModel.UserName%>扮演)
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign="top" colspan="3">議題：<% =CharModel.Subject%>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td height="21" valign="top">月收入：<% =CharModel.SalaryUI%>
                                        </td>
                                        <td height="21" valign="top">人格：<% =CharModel.Personality%>
                                        </td>
