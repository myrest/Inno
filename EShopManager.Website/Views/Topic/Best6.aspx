    ...
    <table class="body0 StepBody">
        <tr>
            <td>
                <div id="body1">
                    <%
                        QuickControllBarViewModel QCBAR = new QuickControllBarViewModel() { ControlMainTitle = "第2單元BEST", ControlSubTitle = "BEST分析-6" };
                ...
                <div id="best-2p">
                    1. 尋找GAP<span class="right"><input type="button" id="EndBest" value="結束Best分析" /></span></div>
                <div id="best-ma1">
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="center">
                                                <tr>
                                                    <td align="center" bgcolor="#FFB7FF">
                                                        B 分類結果
                                                    </td>
                                                </tr>
                                                <%
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <label for="chk_<%=item.BestIdeaGroupSN %>">
                                                            <%=checkboxHTML %>
                                                            <label><% =item.GroupName %></label>(<% =item.Ranking %>)
                                                        </label>
                                                    </td>
                                                </tr>
                                                <%
