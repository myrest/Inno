    ...
    <table class="body0 StepBody">
        <tr>
            <td>
                <div id="body1">
                    <%
                        QuickControllBarViewModel QCBAR = new QuickControllBarViewModel() { ControlMainTitle = "第3單元情境", ControlSubTitle = "情境分析法-3" };
                ...
                <div id="body2" style="<%=HideStyle%>">
                    <table width="95%" border="0" align="center">
                        <tr>
                            <td colspan="3" valign="top" bgcolor="#FFFF99">
                                1. 我的身份：
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table width="95%" border="0" align="center">
                                    <tr>
                                        <td rowspan="4" style="width: 100px;">
                                            <img src="<% =CharModel.ServerFileName%>" width="87" alt="" />
                                        </td>
                                        <td valign="top" colspan="3">
                                            暱稱：<% =CharModel.NickName%> (<% =CharModel.UserName%>扮演)
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign="top" colspan="3">
                                            議題：<% =CharModel.Subject%>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign="top">
                                            性別：<% =CharModel.GenderUI%>
                                        </td>
                                        <td valign="top">
                                            年齡：<% =CharModel.AgeRangUI%>
                                        </td>
                                        <td valign="top">
                                            教育程度：<% =CharModel.EduUI%>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="21" valign="top">
                                            月收入：<% =CharModel.SalaryUI%>
                                        </td>
                                        <td height="21" valign="top">
                                            人格：<% =CharModel.Personality%>
                                        </td>
                                        <td height="21" valign="top">
                                            職業：<% =CharModel.Career%>
                                        </td>
                        ...
                        <tr>
                            <td colspan="3" valign="top" bgcolor="#FFFF99">
                                2. 我發生的情境故事 (請根據 &quot; 人事時地物 &quot; 寫出5件以上該角色在這個議題中發生的事)：
                            </td>
                        </tr>
                        <tr>
                            <td valign="top">
